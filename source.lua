...
local prompt = useStudio and require(script.Parent.prompt) or loadWithTimeout('https://raw.githubusercontent.com/hakutakaid/Rayfield/refs/heads/main/prompt.lua')
...
local Icons = useStudio and require(script.Parent.icons) or loadWithTimeout('https://raw.githubusercontent.com/hakutakaid/Rayfield/refs/heads/main/icons.lua')
-- Variables
